...
#=== E01 ===
E01)
point="E01"    # lon/lat indexes strarting from 0 (ncview convention)
ind_x=19
ind_y=2
lat_p=45.65
lon_p=13.50
...
echo  "# Simulation= WRF-model"                                                 >> $file_out
...
done    # end of loop on grid points (E01, ecc)
