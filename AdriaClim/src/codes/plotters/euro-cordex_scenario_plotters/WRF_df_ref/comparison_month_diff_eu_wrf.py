...
plt.ylabel( "Delta Relative frequency \n($"+months_list[int(month) - 1 ]+"_{"+year_in+"/"+year_fin+"_{WRF}}-"+months_list[int(month) - 1 ]+"_{2010/2020_{EURO-CORDEX}}$)", fontsize=25)
...
plt.savefig( "histogram_diff_eu_wrf_"+field_name+"_"+point_name+"_rcp"+RCP+"_"+str(month).rjust(2, '0')+"_"+year_in+"_"+year_fin+".png" )
