...
#======== pr =========
    ...
    echo "\"river_ratio_cumulative_csv.py\" will be launched right now for \"pr\" field"
    python  river_ratio_cumulative_csv.py  $point_n  $lat_p  $lon_p $RCP  $year_middle

#======================================

(( i++ ))

done < initialization_file_ratio.txt
