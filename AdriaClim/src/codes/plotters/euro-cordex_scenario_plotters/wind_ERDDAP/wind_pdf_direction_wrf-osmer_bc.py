...
for i in range( len( u_v1 ) ):
    phase_erd.append( int( np.around( (270 - np.rad2deg( np.arctan2( v_v1[i], u_v1[i] )))%360, decimals=0)) ) 
...
plt.title("Probability density function for wind direction at point: "+point_name+" ("+point_label[point_name]+").\nWRF-model_bc (W03):1990-2017, OSMER-measures(W04): 1994-2022" , fontsize=25, fontdict={'family':'serif'} )
...
plt.savefig( output_arc_dir+"/wind_pdf_wrf-osmer_"+point_name+"_bc.png")
