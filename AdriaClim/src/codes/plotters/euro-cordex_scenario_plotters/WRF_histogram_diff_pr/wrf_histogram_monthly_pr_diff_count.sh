...
input_arc_dir_wrf="/lustre/arpa/AdriaClim/data/shyfem_inputs/WRF_CRMA/AlpeAdria/20170901-20180101/perturbed"
output_arc_dir="/lustre/arpa/AdriaClim/src/codes/plotters/euro-cordex_scenario_plotters/WRF_histogram_diff_pr"
...
input_file="$file_name"  # the directory path is already included
...
python   wrf_histogram_month_diff_pr.py   $point_n  ${output_arc_dir}/histogram_tmp_data.txt  \
            ${output_arc_dir}/histogram_wrf_tmp_data.txt   ${output_arc_dir}/histogram_tmp_data_ref.txt  $RCP $year_in $year_fin $month $field
#rm       ${output_arc_dir}/histogram_tmp_data_ref.txt   ${output_arc_dir}/histogram_tmp_data.txt ${output_arc_dir}/histogram_wrf_tmp_data.txt
